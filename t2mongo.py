...
#r = api.request('statuses/filter',{'track':'mty, monterrey, sanpedro, spdp, garzagarcia, calzada del valle, margain, av vasconselos, cicmty , implansp , somosbicibles , ciac_mty, alertamty_com, regioseguro, choque, alcance, chocar, chocaron, accidente, vial, peatonal, peligro, peligroso, tr�fico, trafico, calzada, gomez morin, g�mez mor�n, g�mez morin, gomez mor�n, alfonso reyes, tr�nsito, transito, robo, robaron, sem�foro, semaforo', 'locations':'-100.598350, 25.547178, -100.036674, 25.856532'})
